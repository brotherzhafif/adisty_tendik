...
class _FormKoreksiPageState extends State<FormKoreksiPage> {
  ...
  // --- Widget: Ketentuan Pengajuan ---
  Widget _buildKetentuanPengajuan() {
    return Container(
      width: double.infinity,
              ...
              child: Text.rich(
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text:
                          'Koreksi hanya dapat diajukan maksimal 3 hari setelah tanggal presensi.\nData akan di verifikasi oleh admin kepegawaian.\nLampiran bukti bersifat opsional namun disarankan untuk mempercepat proses verifikasi.',
                      style: TextStyle(
                        color: Color(0xFF293241),
                        fontSize: 12,
                        fontFamily: 'Nunito',
